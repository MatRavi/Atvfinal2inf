            ...
            <div id="content">
                ...
                <section class="content">
                    ...
                    <div class="row mb-2">
                        ...
                        <form action="salvaluno.php" method="POST" class="col-lg-12">

                        <div class="col-lg-12">
                            <div class="text-center">
                                <h1 class="h2 text-gray-900 mb-4">Registro de Alunos</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required class="form-control form-control-user" name="sexo" id="sexo" maxlength="1" placeholder="coloque aqui seu sexo">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="text" required class="form-control form-control-user" name="endereco" id="endereco"
                                        placeholder="coloque aqui seu endereço">
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-4 mb-sm-0">
                                        <input type="date" required class="form-control form-control-user" name="data"
                                            id="data">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" required class="form-control form-control-user" name="fone"
                                            id="fone" placeholder="coloque aqui seu telefone">
                                    </div>
                                </div>
