    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="row mb-2">
                        <div class="m-3 col-11">
                                <div class="d-sm-flex justify-content-between">
                                    <a href="buscacurso.php" class="btn btn-primary btn-icon-split">
            ...
            <hr>
                    ...
                    <form action="atualizacurso.php" method="POST" class="col-lg-12">

<div class="col-lg-12">
    <div class="text-center">
        <h1 class="h2 text-gray-900 mb-4">Alterar de Curso</h1>
    </div>
    <form class="user">
        ...
        <div class="form-group row">
            <div class="col-sm-6 mb-1 mb-sm-0">
                <input type="text" required class="form-control form-control-user" value="<?php echo $linha['cargahoraria']?>" name="ch" id="ch">
            </div>
            <div class="col-sm-6">
                <input type="text" required class="form-control form-control-user" value="<?php echo $linha['turno']?>" name="turno" id="turno">
            </div>
        </div>
        ...
        <div class="form-group">
            <input type="text" required class="form-control form-control-user" value="<?php echo $linha['codcurso']?>" name="cod" id="cod">
        </div>
