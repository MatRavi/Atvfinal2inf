            ...
            <div id="content">
                ...
                <section class="content">
                    ...
                    <div class="row mb-2">
                        ...
                        <form action="salvamatri.php" method="POST" class="col-lg-12">

                        <div class="col-lg-12">
                            <div class="text-center">
                                <h1 class="h2 text-gray-900 mb-4">Registro de Matriculas</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group">
                                    <select class="form-control form-control-user" name="usu" id="usu">
                                        ...
                                        <?php 
                                            ...
                                            if($consulta3){
                                                ...
                                                if($consulta3->num_rows > 0){
                                                    ...
                                                    echo '<option value="'.$linha3['codusu'].'">'.$linha3['nome'].' | '.$linha3['email'].'</option>';
                                                    }
                                                }
                                            }
                                        ?>
