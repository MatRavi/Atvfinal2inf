    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <hr>
                    ...
                    <form action="atualizausu.php" method="POST" class="col-lg-12">

<div class="col-lg-12">
    <div class="text-center">
        <h1 class="h2 text-gray-900 mb-4">Alterar de Usuário</h1>
    </div>
    <form class="user">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" required class="form-control form-control-user" readonly value="<?php echo $linha['codusu']?>" name="cod" id="cod">
            </div>
        </div>
        ...
        <div class="form-group">
            <input type="text" required class="form-control form-control-user" value="<?php echo $linha['email']?>" name="email" id="email">
        </div>
        ...
        <div class="form-group">
            <input type="password" required class="form-control form-control-user" value="<?php echo $linha['senha']?>" name="senha" id="senha">
        </div>
