            ...
            <div id="content">
                ...
                <section class="content">
                    <div class="container-fluid">
                      <div class="row">
                        <div class="col-12">
                        <div class="card border-left-primary mb-3 shadow h-80 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <h5><i class="fas fa-info"></i> Atenção:</div></h5>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            Sistema de Matriculas - 2º informática - 2022</div>
                                        </div>
                                        <div class="col-auto">
                              ...
                              <?php
                                if(isset($_GET['login'])){
                                  if($_GET['login'] =='ok'){
                                    ...
                                    <h5><i class="icon fas fa-check"></i> Olá!</h5>
