            ...
            <div id="content">
                ...
                <section class="content">
                    ...
                    <div class="row mb-2">
                        ...
                        <form action="salvacurso.php" method="POST" class="col-lg-12">

                        <div class="col-lg-12">
                            <div class="text-center">
                                <h1 class="h2 text-gray-900 mb-4">Registro de Cursos</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required class="form-control form-control-user" name="turno" id="turno" placeholder="coloque aqui o turno">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="text" required class="form-control form-control-user" name="ch" id="ch"
                                        placeholder="coloque aqui a carga horária" maxlength="5">
                                </div>
